...
try {
  ...
  for (const marker of ['104 explained questions', 'Rerun orientation', 'Practice & review', 'Review before keeping', 'cannot promise anonymity', 'aria-modal="true"', 'MutationObserver', 'Optional animated OS learning companion', 'orbit-os-anime', 'Ask AI coach', 'prefers-reduced-motion', 'Self-reported coursework planning progression', 'Create portable coursework workspace', 'Run coursework preflight', 'Cross-platform setup', 'Prepare verified xv6 reference', 'Run assignment preflight', 'Verified reference implementations']) {
