...
export const WALKTHROUGH_STEPS = [
  { id: 'assistance', title: 'Check U-M Codex assistance', detail: 'Before setup, verify the student-owned U-M Codex CLI or use private offline Orbit. AI is optional and never blocks course access.' },
...
export const FAQS = [
  ...
  { id: 'ai-options', question: 'Which U-M AI service should I use?', answer: 'Use U-M Codex CLI, the course’s single online AI route. It runs in VS Code with your own U-M configuration and reads the course guardrails in generated workspaces. Orbit never uses an instructor API key or a private instructor-hosted model.' },
  { id: 'setup-ai', question: 'Can U-M Codex install or repair the environment for me?', answer: 'Codex can explain a reviewed short diagnostic and recommend one safe next step. It cannot accept licenses, grant administrator privileges, enable virtualization, or prove success without a verification result. Orbit performs bounded local checks and safe actions; you review permissions and confirm the result.' },
