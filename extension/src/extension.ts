...
const tabs=[['home','Course home'],['schedule','Course plan'],['modules','Modules'],['practice','Practice & review'],['labs','Guided labs'],['simulations','OSTEP simulations'],['coursework','Coursework'],['progress','My local progress'],['help','Questions & help']];
...
function renderAll(){renderHome();renderSchedule();renderModules();renderPractice();renderLabs();renderSimulations();renderCoursework();renderProgress();renderHelp();renderWalkthrough();renderCompanion();applyA11y()}
