...
function renderHelp(){
  ...
  el.querySelector('.quick').onclick=e=>{el.querySelector('#question').value=e.target.dataset.question;el.querySelector('#ask').click()};
...
function renderAll(){renderHome();renderModules();renderPractice();renderLabs();renderCoursework();renderProgress();renderHelp();renderWalkthrough();renderCompanion();applyA11y()}
