...
const AUTHORED_MODULES: readonly AuthoredCourseModule[] = [
  {
    ...
    sourceAlignment: 'OSTEP Chapter 2 introduces the operating system’s core goals. This module connects those goals to mechanism-versus-policy reasoning and a reproducible C and Unix workflow.',
    questions: [
  ...
  },
  {
    ...
    sourceAlignment: 'OSTEP Chapters 4–5 explain the process abstraction and its APIs. This module turns that reading into fork, exec, wait, exit, and shell traces.',
    questions: [
  ...
  },
  {
    ...
    sourceAlignment: 'OSTEP Chapters 6–10 progress from limited direct execution to scheduling policies. This module emphasizes reproducible traces, response and turnaround metrics, and policy tradeoffs.',
    questions: [
  ...
  },
  {
    ...
    sourceAlignment: 'OSTEP Chapters 13–16 introduce address spaces, the memory API, relocation, and segmentation. This module focuses on protection checks, translation arithmetic, and fragmentation evidence.',
    questions: [
  ...
  },
  {
    ...
    sourceAlignment: 'OSTEP Chapters 18–20 develop paging, translation caches, and multi-level page tables. This module uses address decompositions and state tables to make each lookup step visible.',
    questions: [
  ...
  },
  {
    ...
    sourceAlignment: 'OSTEP Chapters 21–22 explain demand paging and replacement policy. This module connects page-fault mechanisms to FIFO, LRU, OPT, and Clock traces under explicit frame counts.',
    questions: [
  ...
  },
  {
    ...
    sourceAlignment: 'OSTEP Chapters 26–27 introduce threads, shared state, and the pthread API. This module uses concrete interleavings to connect the abstraction to race and atomicity reasoning.',
    questions: [
  ...
  },
  {
    ...
    sourceAlignment: 'OSTEP Chapters 28–29 explain locks and lock-based data structures. This module connects critical-section invariants to mutex ownership, atomic primitives, and data-structure correctness.',
    questions: [
  ...
  },
  {
    ...
    sourceAlignment: 'OSTEP Chapters 30–31 develop condition variables and semaphores. This module uses bounded-buffer and ordering cases to practice both safety and progress reasoning.',
    questions: [
  ...
  },
  {
    ...
    sourceAlignment: 'OSTEP Chapter 32 classifies common concurrency failures. This module connects wait-for graphs and the Coffman conditions to prevention, avoidance, detection, and non-deadlock bugs.',
    questions: [
  ...
  },
  {
    ...
    sourceAlignment: 'OSTEP Chapter 36 explains the I/O path from software to devices. This module compares polling, interrupts, and DMA while tracing responsibility across the application, kernel, driver, and device.',
    questions: [
  ...
  },
  {
    ...
    sourceAlignment: 'OSTEP Chapter 39 explains files, directories, descriptors, links, and metadata. This module turns the APIs into state and namespace traces that distinguish names from open objects.',
    questions: [
  ...
  },
  {
    ...
    sourceAlignment: 'OSTEP Chapters 40–42 develop file-system layout, locality, and crash consistency. This module uses access-path and write-order traces to connect on-disk structures to recovery guarantees.',
    questions: [
...
export const COURSEWORK: readonly CourseworkItem[] = [
  ...
  { id: 'pa3', kind: 'Programming', title: 'Programming 3 · Synchronization System', focus: 'Coordinate concurrent actors in a traffic-control scenario with pthread locks and semaphores.', modules: [7, 8, 9, 10], evidence: ['Deterministic test scenarios where possible.', 'Timestamped event trace.', 'Safety and progress argument.', 'Fall 2026 specification and deadline come from Canvas.'], expectedExtensions: ['c', 'h', 'patch', 'diff', 'txt', 'md', 'pdf', 'zip', 'tar', 'gz'], practiceLabIds: ['lock-invariant', 'condition-buffer', 'deadlock-order'] }
] as const;
